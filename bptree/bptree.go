...
//	tree := NewBPTree(4)
//	//
//	//	//tree.Set(10, ValueData{Authority: "doctor", EncData: "10xxx"})
//	//	//tree.Set(16, ValueData{Authority: "doctor", EncData: "16xxx"})
//	//	//tree.Set(20, ValueData{Authority: "doctor", EncData: "xxx"})
//	//	//tree.Set(40, ValueData{Authority: "doctor", EncData: "xxx"})
//	//	//tree.Set(50, ValueData{Authority: "doctor", EncData: "xxx"})
//	//	//tree.Set(55, ValueData{Authority: "doctor", EncData: "55xxx"})
//	//	//tree.Set(60, ValueData{Authority: "doctor", EncData: "xxx"})
//	//	//tree.Set(69, ValueData{Authority: "doctor", EncData: "xxx"})
//	//	//tree.Set(77, ValueData{Authority: "doctor", EncData: "xxx"})
//	//	//tree.Set(80, ValueData{Authority: "doctor", EncData: "xxx"})
//	//	//tree.Set(85, ValueData{Authority: "doctor", EncData: "xxx"})
//	//	//tree.Set(84, ValueData{Authority: "doctor", EncData: "xxx"})
//	//	//tree.Set(90, ValueData{Authority: "doctor", EncData: "xxx"})
//	//	//tree.Set(87, ValueData{Authority: "doctor", EncData: "xxx"})
//	//	//tree.Set(86, ValueData{Authority: "doctor", EncData: "xxx"})
//	//	//tree.Set(96, ValueData{Authority: "doctor", EncData: "96xxx"})
//	//
//	tree.Set(1, ValueData{Authority: "doctor", EncData: "10xxx"})
//	tree.Set(2, ValueData{Authority: "doctor", EncData: "16xxx"})
//	tree.Set(3, ValueData{Authority: "doctor", EncData: "xxx"})
//	tree.Set(4, ValueData{Authority: "doctor", EncData: "xxx"})
//	tree.Set(5, ValueData{Authority: "doctor", EncData: "xxx"})
//	tree.Set(6, ValueData{Authority: "doctor", EncData: "55xxx"})
//	tree.Set(7, ValueData{Authority: "doctor", EncData: "xxx"})
//	tree.Set(8, ValueData{Authority: "doctor", EncData: "xxx"})
//	tree.Set(9, ValueData{Authority: "doctor", EncData: "xxx"})
//	tree.Set(10, ValueData{Authority: "doctor", EncData: "xxx"})
//	tree.Set(11, ValueData{Authority: "doctor", EncData: "xxx"})
//	tree.Set(12, ValueData{Authority: "doctor", EncData: "xxx"})
//	tree.Set(13, ValueData{Authority: "doctor", EncData: "xxx"})
//	tree.Set(14, ValueData{Authority: "doctor", EncData: "xxx"})
//	tree.Set(15, ValueData{Authority: "doctor", EncData: "xxx"})
//	tree.Set(16, ValueData{Authority: "doctor", EncData: "16xxx"})
//	res, count := tree.Get(16)
//	fmt.Println("res:", res, "count:", count)
//	//	tree.Set(17, ValueData{Authority: "doctor", EncData: "17xxx"})
//	//	tree.Set(18, ValueData{Authority: "doctor", EncData: "18xxx"})
//	//	tree.Set(19, ValueData{Authority: "doctor", EncData: "19xxx"})
//	//	tree.Set(20, ValueData{Authority: "doctor", EncData: "20xxx"})
//	//	tree.Set(21, ValueData{Authority: "doctor", EncData: "21xxx"})
//	//	tree.Set(22, ValueData{Authority: "doctor", EncData: "22xxx"})
//	//	tree.Set(23, ValueData{Authority: "doctor", EncData: "23xxx"})
//	//	tree.Set(24, ValueData{Authority: "doctor", EncData: "24xxx"})
//	//	tree.Set(25, ValueData{Authority: "doctor", EncData: "25xxx"})
//	//	tree.Set(26, 26)
//	//	res := tree.Get(26)
//	//	fmt.Printf("res:%+v\n", res)
//	//	//fmt.Printf("root:%+v\n", tree.GetData())
